...
function mysteryFunction1(p1) {
  ...
  // The functions multiplies a value by 2.
  // 2. What prints out for the value of y
  //The value of y is 4.
  // 3. What prints out for the value of z
  //The value of z is likely 8.
  // Now run the code and see if you're correct.
  // Were you correct? If not, what did you learn?
  //Yes I assumed the function was taking the value of y and multiplying it by 2 and assigning it to the value of z.
  ...
  //This function subteacts the values of two variables
  ...
  // Now run the code and see if you're correct.
  // Were you correct? If not, what did you learn?
  //Yes, I was coorect using the same logic as the previous exercise. 
