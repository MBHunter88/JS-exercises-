...
console.log(exercise4("12", 12));
console.log(exercise4("twelve", 12));
console.log(exercise4("12", "12"));
console.log(exercise4(12, 12));
// EXERCISE 5.
...
console.log(`{Exercise 5: } // If the two "falsy" data types were compared or if we used the (===) to compare variables then the desired ouput would not be reached.`)
// EXERCISE 6.
...
console.log(exercise6(4, 6, 6));
console.log(exercise6(5, 5, 5));
console.log(exercise6(4, 4, 6));
...
console.log(exercise8(12, 24, 3, 24));
console.log(exercise8(1, 9, 3, 8));
console.log(exercise8(5, 7, 1, 22));
